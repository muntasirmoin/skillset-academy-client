    ...
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div className=''>
                  <h2 className="mb-6 text-sm font-semibold text-white-900 uppercase text-center">Contact Information</h2>
                  {/* <ul className="flex flex-col space-y-2"> */}
                  <ul className="text-gray-600 dark:text-gray-400 font-medium text-center">
          
          <li>Email: skillset_academy@gmail.com</li>
          <li>Phone: +88 1768968938</li>
              ...
              <div>
              <h2 className="mb-6 text-sm font-semibold text-white-900 uppercase text-center">Address</h2>
                  <ul className="text-gray-600 dark:text-gray-400 font-medium text-center">
                    <li>SkillSet Academy,</li>
                  <li>Sylhet,</li>
          <li>Bangladesh.</li>
                  </ul>
              </div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="#" className="hover:underline">SkillSet Academy™</a>. All Rights Reserved.
          </span>
          <div>
          <div className="footer-title text-center">Social</div>
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
              <a href="#" className="text-gray-500 hover:text-blue-900 dark:hover:text-white">
              ...
              <a href="#" className="text-gray-400 hover:text-pink-900 dark:hover:text-gray-400">
